...
export class Debug implements Scheduler {
    private jobs: Job[] = [
        ...
        new Job("5", "job5", "COMPLETED", "debug", "job5.sh", "job5.out", new WallTime(0, 7, 0, 0), new WallTime(0, 7, 0, 0)),
        new Job("6", "job6", "TIMEOUT", "debug", "job6.sh", "job6.out", new WallTime(0, 1, 30, 0), new WallTime(0, 1, 30, 0)),
        new Job("7", "job7", "CANCELLED", "debug", "job7.sh", "job7.out", new WallTime(0, 23, 59, 59), new WallTime(0, 0, 0, 0)),
        new Job("8", "job8", "FAILED", "debug", "job8.sh", "job8.out", new WallTime(0, 0, 5, 0), new WallTime(0, 0, 0, 0)),
    ];
